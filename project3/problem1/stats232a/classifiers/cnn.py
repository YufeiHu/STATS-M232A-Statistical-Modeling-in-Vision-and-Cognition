...
class ThreeLayerConvNet(object):
    ...
    def __init__(self, input_dim=(3, 32, 32), num_filters=32, filter_size=7,
        ...
        self.params['W1'] = weight_scale * np.random.randn(num_filters, D, filter_size, filter_size)
    ...
    def loss(self, X, y=None):
        ...
        margin, cache1 = conv_relu_pool_forward(X, W1, b1, conv_param, pool_param)
        margin, cache2 = fc_relu_forward(margin, W2, b2)
        scores, cache3 = fc_forward(margin, W3, b3)
        ...
        dmargin, dW3, db3 = fc_backward(dscores, cache3)
        dmargin, dW2, db2 = fc_relu_backward(dmargin, cache2)
        dx, dW1, db1 = conv_relu_pool_backward(dmargin, cache1)
